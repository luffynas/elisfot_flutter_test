  ...
  static Future<Map<String, dynamic>> get(String path) async {
    return ApiClient()
      ...
      if (resp == null || resp.body == null) {
        throw AppException(message: 'Cannot connect to server (code: 5832)');
      }
      // ignore: avoid_dynamic_calls
...
void checkValidResp(Map<String, dynamic> respData) {
  var code = respData['status_code'] as int;
  if (code != 0) {
...
void checkValidResultResp(Map<String, dynamic> respData) {
  if (!respData.containsKey('data')) {
    ...
    throw AppException(
        message: 'Invalid server response, please report to developer');
  }
}
